    ...
    sections = [
        {
            ...
            "rows": [
                ...
                {"key": "past_participle", "label": "past participle", "text": forms.get("past_participle", "")},
                {"key": "present_3sg", "label": "3rd person sg", "text": forms.get("present_3sg", "")},
                {"key": "gerund", "label": "gerund", "text": forms.get("gerund", "")},
            ],
        }
    ]
    return Board(language="en", verb=verb, voice_key=voice_key, voice_label=voice_label, sections=sections)
